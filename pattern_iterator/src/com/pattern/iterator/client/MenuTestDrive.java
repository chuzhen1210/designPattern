...
import com.pattern.iterator.impl.Waitress;
import com.pattern.iterator.intf.MenuComponent;

public class MenuTestDrive {

	public static void main(String[] args) {
		testWaitressWithComponent();
	}

	private static void testWaitressWithComponent() {
...
//		allMenus.add(cafeMenu);
		...
		pancakeHouseMenu.add(new MenuItem("Waffles", "Wafffles, with your choice of blueberries or strawberries", true, 3.59));
...
//		dinerMenu.add(new MenuItem("Hotdot", "A hot dog, with saurkraut, relish, onions, topped with cheese", false, 3.05));
